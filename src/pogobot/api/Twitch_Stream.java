...
public class Twitch_Stream
{
	...
	{
		setTitle(job.get("status").getAsString());
		setMeta_game(job.get("game").getAsString());
		setName(job.get("display_name").getAsString());
		setFollowers(job.get("followers").getAsInt());
		setViews_count(job.get("views").getAsInt());
		/*
		...
		setTitle(job.get("status").getAsString());//wastitle
	...
	public void setFollowers(int asInt) { followers = asInt; }
	...
	public void setChannel_url(String channel_url) { this.channel_url = channel_url; }
